...
# # using a coma (,) allow cobining different types of values with an automatically added whitespace
...
print("my skills are")
print(" -", skill1, f"({level1})")
print(" -", skill2, f"({level2})")
print(" -", skill3, f"({level3}) \n")
